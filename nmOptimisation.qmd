...
2.  We know that we want to maximise this function so go through the full Calculus exercise to find the maximum:
    ...
    Check that your answer is $20/3$.
...
\end{equation}
This is the second time the golden ratio has shown up in this module. One simply has to love Maths.
...
::: {#exr-3.54}
💻 Make a plot of the log of the absolute error at iteration $n+1$ against the log of the absolute error at iteration $n$, similar to @fig-2.4, for several choices of function and starting points. What do you observe?
:::
