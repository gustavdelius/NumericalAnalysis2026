...
The Mean Value Theorem implies the existence of a number $\xi\in(\min\{p,q\},\max\{p,q\})\in(a,b)$ such that 
$$
...
For each $n\ge0$ the Mean Value Theorem gives the existence of a $\xi\in(\min\{x_n,p\},\max\{x_n,p\})\in(a,b)$ such that
$$
