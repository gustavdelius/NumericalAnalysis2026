...
$$
\mathbf{\epsilon}^{(n)}n=A^n\mathbf{\epsilon}.
$$
...
$$
for $k=1,\ldots,N_x-1$. For stability we need $|\lambda_k|<1$ for all $k$, i.e.,
$$
0\leq a\left(\sin\left(\frac{k\pi}{2N_x}\right)\right)^2<\frac12
$$
