...
::: {#exr-5.50}
💻 🎓 Complete the function `backwardEuler1d()` below. How do you define the function `G` inside the `for` loop and what starting value do you use for the `fsolve()` command?
