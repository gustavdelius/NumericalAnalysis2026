...
::: {#exr-3.29}
💻 💬 Test your second derivative code on the function $f(x) = \sin(x) (1-x)$ to calculate the second derivative at $x=1$ and comparing it to the exact answer you determined in @exr-3.27.
:::
